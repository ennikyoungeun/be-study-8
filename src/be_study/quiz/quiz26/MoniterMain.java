...
public class MoniterMain {
	...
	public static void main(String[] args) {
		...
		//2) LG 32인치 330,000
		//Moniter m1=new Moniter("삼성",27,150000,"검은색");
		Moniter m1=new Moniter("삼성",27,150000);
		m1.setColor("검은색");
		
		Moniter m2=new Moniter("LG",32,330000);
