...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
		...
		/* 출력 ->
		  Response code: 200
		  {"response":{"body":{"tableList":[{"items":{"item":[{"basYm":"201312","crno":
		  "1101110377203",
		  "fncoCd":"0010225","fncoNm":"현대카드㈜","xcsmCnt":"1410","xcsmDcd":"A",
		  "xcsmDcdNm":"총임직원"}]},"title":"신용카드_일반현황_임직원현황",
		  "totalCount":72}]},"header":{"resultCode":"00","resultMsg":"NORMAL SERVICE.",
