...
public class quiz06 {
	...
	public static void main(String[] args) {
		...
		// 삼각형의 넓이 = 밑변 * 높이 / 2 ;
		  ...
		  System.out.print("삼각형의 밑변 입력 : "); int width1 = scanner.nextInt();
		  
		  System.out.print("삼각형의 높이 입력 : "); int height1 = scanner.nextInt();
		 
		  //넓이 계산 -> 출력 System.out.println("삼각형의 넓이는 : " + ((double)width1*height1/2));
		...
		System.out.println("사다리꼴의 넓이는 : " + ((double)(top+width2)*height2/2));
		...
		int student = 24;
		int snack = 100;
		System.out.println("한명당 받는 과자 수 : " + (snack / student));
		System.out.println("남는 과자 수 : " + (snack % student));
