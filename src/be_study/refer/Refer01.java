...
public class Refer01 {
	...
	public static void main(String[] args) {
		...
		int n;               //값X 기본타입 변수
		int num =0;          //값O 기본타입 변수
		
		String s1;           //값X 참조타입 변수
		String s2 = null;    //참조하는게 없다! null 
		
		
		/*
		 * System.out.println(n); System.out.println(s1);
		 */
		...
		String t1 = "사과";
		String t2 = "사과";
		String t3 = scanner.nextLine();      //문자열 입력받기
		String t4 = new String ("사과");
		String t5 = "사과";
		
		System.out.println(t1==t2);         //주소비교
		System.out.println(t1.equals(t2));  //실제 문자열 값을 비교 
...
//		System.out.println(ne.equals("사과"));
		...
		int n1 =10;
		int n2 = n1;
		System.out.println(n1); //정수형 변수안에 들어있는 값복사
